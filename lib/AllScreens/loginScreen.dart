        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text(
                'Войдите в систему как водитель',
              ...
              TextButton(
                ...
                child: const Text('Зарегистрируйтесь здесь', style: TextStyle(fontSize: 20, fontFamily: 'Rowdies'),
                ),
              )
            ],
          ),
  ...
  void loginAndAuthenticatUser(BuildContext context) async {
    ...
    try {
      ...
      if (firebaseUser != null) {
        ...
        final DatabaseEvent event = await driversRef.child(firebaseUser.uid).once();
      ...
      if (e.code == 'user-not-found' && firebaseUser == currentfirebaseUser ) {
        // ignore: use_build_context_synchronously
        displayToastMessage(
